...
public class WetLand {
    ...
    public boolean addEvents(int type,String organizer, double price, String description,int day,int month,int year){
    ...
    public int wetlandMaxFauna(){
        ...
        for (int i = 0;i < species.length; i++){
            if (species[i]!=null){
                if ( (species[i].getType().equals(TypeSpecie.ACUATIC_FAUNA) | (species[i].getType().equals(TypeSpecie.BIRD) | (species[i].getType().equals(TypeSpecie.MAMMAL))))){
                sum += 1;
    ...
    public int wetlandLeastFlora(){
        int sum = 0;
            for (int i = 0; i < species.length; i++){
                if (species[i]!=null){
                    if ( (species[i].getType().equals(TypeSpecie.TETRESTIAL_FLORA) | (species[i].getType().equals(TypeSpecie.ACUATIC_FLORA)))){
                    sum += 1;
                    }
                }
