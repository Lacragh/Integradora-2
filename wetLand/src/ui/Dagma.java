...
import model.WetLandController;
    ...
    public static WetLandController controller;
        ...
        public static void menu(){
            ...
            System.out.println("|-------------------------------------------|");
            System.out.print("Type Here ------>");answerMenu = lector.nextInt();
            ...
            switch(answerMenu){
                ...
                System.out.println("What is the type of event to register\n1. MAINTENANCE\n2. SCHOOL VISITS\n3. ACTIVITIES\n4. CELEBRATION");
                ...
                if (controller.registerEvent(wetlandID,typeEvent, organizer, price, descriptionEvent, day, month, year)){
